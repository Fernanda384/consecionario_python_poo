...
-Este programa esta divido en 4 archivos: main.py=> en donde se encuentra el menu principal en donde se inica el programa; automovil.py(clase hija), moto.py(clase hija) y vehiculo.py (clase padre)
